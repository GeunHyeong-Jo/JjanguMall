...
<input type="hidden" id="goodsDTO" value="${productDTO}">
	<div id="main">
		...
		<div id="goodsView_area">
			...
			<div id="goods_main">
				...
				<div id="goods_subject">
					<div>
						<b name="productName" style="font-size: 20pt; font-weight: 700;">${productDTO.name}</b>
					</div>
					...
					<div>
						...
						<div class="item_contents" name="origin">${productDTO.origin}</div>
					</div>
					<div>
						<div class="items">제조사</div>
						<div class="item_contents" name="manufacturer">${productDTO.manufacturer}</div>
					</div>
					...
					총 금액&ensp;:&ensp;<span id="priceSpan" style="font-size: 22px; color: #333; font-weight: 600;">${productDTO.price}</span>
					<span>&ensp;원</span>
					</div>
...
<script type="text/javascript">
var userId = "${memId}";
var productCode = ${productDTO.productNo};
var originalPrice = ${productDTO.price};
var discountPrice = ${productDTO.price};
var showDiv = 0;
