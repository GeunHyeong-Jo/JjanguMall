...
<div id="top_1" style="width:1000px;">
	<div id="top_menu_area">
		...
		<ul id="top_menu" class="utilMenu">
			<li><a href="${pageContext.request.contextPath }/used/index" class="utilMenuText">중고</a></li>
			...
			<li><a href="${pageContext.request.contextPath }/used/user/sellitem" class="utilMenuText">거래 목록</a></li>
			</c:if>
		</ul>
	</div><!-- top_menu_area 끝-->
</div><!-- top_1 끝-->
