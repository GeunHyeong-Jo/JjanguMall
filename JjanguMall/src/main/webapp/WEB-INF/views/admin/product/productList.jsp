	...
	<div id="product_search_wrap" style="width: 1200px; margin: 0 auto;">
		...
		<form id="checkDeleteForm" method="post"
			...
			<div id="productSeach_list" align="left" style="margin-top: 50px;">
				<table id="productSearch_Table" border="1"
					style="width: 100%; border: 1px solid #d9dadc; border-spacing: 0; line-height: 1.5;">
					<tr>
						<th style="width: 44px;"><input type="checkbox"
							id="check_all"></th>
					...
					<c:forEach var="list" items="${list}">
						<tr>
							<td align="center" style="height: 31px;"><input
								type="checkbox" value="${list.productCode }" name="check"
								class="check"></td>
							<td align="center">${list.productCode }</td>
							<td style="padding-left: 5px;"><a href="javascript:void(0)"
								id="productA" class="${list.productCode }">${list.productName }</a>
							</td>
