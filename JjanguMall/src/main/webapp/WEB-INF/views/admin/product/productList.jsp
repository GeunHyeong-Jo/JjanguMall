				...
				<c:forEach var="ProductDTO" items="${list}">
					<tr>
						<td align="center" style="height: 31px;">
							<input type="checkbox" value="${ProductDTO.productNo }" name="check" class="check">
						</td>
						<td align="center">${ProductDTO.productNo }</td>
						<td style="padding-left: 5px;">
							<a href="javascript:void(0)" id="productA" class="${ProductDTO.productNo }">${ProductDTO.name }</a>
						</td>
						<td align="center">${ProductDTO.price }</td>
						<td align="center">${ProductDTO.totalQty }</td>
						<td align="center">${ProductDTO.stockQty }</td>
						<td align="center">${ProductDTO.saleQty }개</td>
						<td align="center">${ProductDTO.reg_date }</td>
					</tr> 
				</c:forEach>
...
$('#productSearch_Table').on('click', '#productA',function(){
	location.href="${pageContext.request.contextPath }/admin/productModifyForm?productNo="+$(this).attr('class');
});
